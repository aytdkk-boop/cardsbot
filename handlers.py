...
async def ask_query(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "<b>Доступные виды поиска по адресу :</b>\n"
        "<code>ул. Новокосинская, д.1</code>\n"
        "<code>Новокосинская 1</code>\n"
        "<code>Новокосинская 1к1</code>\n"
        "<code>Новокосинская 1к1с1</code>\n\n"
        "<b>Доступные виды поиска по координатам :</b>\n"
        "<code>55.750289, 37.856334</code>",
